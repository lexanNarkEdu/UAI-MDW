...
public partial class GananciasGeneral : System.Web.UI.Page
{
    ...
    private void CargarDatos()
    {
        try
        {
            ...
            List<BE.ReporteGanancias> reportes = reportesBll.ObtenerGananciasGeneral();
        ...
        catch (Exception ex)
        {
            ...
            lblEstadisticas.Text = "Error al cargar los datos: " + ex.Message;
