<%@ Page Title="Ganancias Último Mes" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="GananciasUltimoMes.aspx.cs" Inherits="GananciasUltimoMes" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="reporte-wrapper">
        <h2>📅 Reporte de Ganancias - Último Mes</h2>
        
        <div class="periodo-info">
            📊 Mostrando ganancias de los últimos 30 días por categoría
        </div>
            ...
            <ContentTemplate>
                ...
                <div class="grid-container">
                    <asp:GridView ID="gvGanancias" runat="server" 
                        ...
                        EmptyDataText="No se encontraron datos de ganancias del último mes.">
                        <Columns>
                            <asp:BoundField DataField="Categoria" HeaderText="Categoría" />
                            <asp:BoundField DataField="VentasConEstaCategoria" HeaderText="# Ventas (30 días)" />
                        ...
                        <EmptyDataTemplate>
                            <div class="no-data">
                                📈 No hay datos de ganancias disponibles en el último mes.
                            </div>
                        </EmptyDataTemplate>
                    </asp:GridView>
                </div>
