<%@ Page Title="Ganancias General" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="GananciasGeneral.aspx.cs" Inherits="GananciasGeneral" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="reporte-wrapper">
        <h2>📊 Reporte de Ganancias General por Categoría</h2>
                ...
                <div class="grid-container">
                    <asp:GridView ID="gvGanancias" runat="server" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="VentasConEstaCategoria" HeaderText="# Ventas" />
                        ...
                        <EmptyDataTemplate>
                            <div class="no-data">
                                📈 No hay datos de ganancias disponibles en este momento.
                            </div>
                        </EmptyDataTemplate>
                    </asp:GridView>
                </div>
